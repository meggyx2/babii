...
async def status(ctx, a, b, *, status: str = " "):
    if ctx.message.author.id != 255843067112718336 and ctx.message.author.id == 623181235338084362 or ctx.message.author.id == 270297848568872981 or ctx.message.author.id == 592843418992902175:
        if len(a) != 0:
